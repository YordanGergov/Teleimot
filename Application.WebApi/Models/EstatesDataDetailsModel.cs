...
{
    public class EstatesDataDetailsModel
    {
        public EstatesDataDetailsModel()
        {

        }


        public static Expression<Func<Estate, EstatesDataDetailsModel>> FromEstate
        {
            get
            {
                return a => new EstatesDataDetailsModel
                {
